...
public class Player extends Entity {
    ...
    public void getPlayerImage() {
        try {
            up1 = ImageIO.read(getClass().getResourceAsStream("/res/player/back-1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/res/player/back-2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/res/player/front-1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/res/player/front-2.png"));
